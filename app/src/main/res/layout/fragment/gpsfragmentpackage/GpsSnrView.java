...
class GpsSnrView
    ...
    private void doInit(Context context) {
        ...
        gridPaintStrong.setColor(Color.parseColor("#000000"));// Black for graph line

        gridPaintNone = new Paint(gridPaint);
        gridPaintNone.setColor(Color.parseColor("#FFFFFFFF"));
		 ...
		 */
        preferredHeight = (int) (
                (6 * labelPaint.getTextSize() + context.getResources().getDimensionPixelSize(R.dimen.abc_text_size_medium_material))
     ...
     *
     * @param canvas The {@code Canvas} on which the SNR view will appear.
     * @param nmeaID The NMEA ID of the satellite, as returned by {@link GpsSatellite#getPrn()}.
